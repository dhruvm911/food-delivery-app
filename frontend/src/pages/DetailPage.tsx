...
const DetailPage = () => {
    ...
    const addToCart = (menuItem: MenuItem) => {
        setCartItems((prevCartItems) => {
            //1. check if item is already is in cart
            ...
            if(existingCartItem){
                updatedCartItems = prevCartItems.map((cartItems) => cartItem._id === menuItem._id ? {...cartItem, quantity: cartItem.quantity + 1}: cartItem);
            } else{
                updatedCartItems = [
                    ...prevCartItems, {
                        _id: menuItem._id,
